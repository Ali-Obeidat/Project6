  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="{{route('home')}}">
        ...
        <div class="sidebar-brand-text mx-3">Public Site </div>
      </a>
      ...
      <li class="nav-item">
        ...
        <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="{{route('exams.index')}}">Show Exams </a>
            <a class="collapse-item" href="{{route('exams.create')}}">Add Exam </a>
            <a class="collapse-item" href="{{route('questions.create')}}">Add question to exam</a>
          </div>
        </div>
      </li>
